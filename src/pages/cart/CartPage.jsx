                ...
                <tr key={product.id} className="border-b border-b-gray-200">
                  ...
                  <td className="px-4 py-2 text-center">
                    <div className="flex items-center justify-center gap-2">
                      <button className="cursor-pointer rounded bg-gray-200 px-2 py-0 font-bold hover:bg-gray-400">
                        -
                      </button>
                  ...
                  <td className="px-4 py-2 text-right">
                    <button className="cursor-pointer text-red-400 hover:text-red-700">
