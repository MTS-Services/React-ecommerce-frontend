    ...
    <header
      className={`fixed top-0 right-0 left-0 z-50 transition-all duration-300 ${
        isScrolled
          ...
          : "bg-gradient-to-r from-[#f1e4e1] to-[#f5f0ef] py-4"
      }`}
    >
        ...
        <div className="flex items-center justify-between">
            ...
            <ul className="flex space-x-6 text-center font-semibold">
              ...
              {categoriesData.map((category, index) => (
                <li className="relative" key={index}>
                  <button
                    className="relative flex items-center px-1 py-2 text-black transition-colors after:absolute after:-bottom-1 after:left-0 after:h-0.5 after:w-0 after:bg-[#19B2E7] after:transition-all after:content-[''] hover:text-[#19B2E7] hover:after:w-full"
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  {/* Dropdown menu for subcategories with animation */}
                  <AnimatePresence>
                    {openCategoryIndex === index && (
                      <motion.div
                        ...
                        className="absolute top-full left-0 z-20 mt-2 w-56 overflow-hidden rounded-md bg-white shadow-lg"
                          ...
                          {category.subCategories.map(
                            (subCategory, subIndex) => (
                              ...
                              >
                                <a
                                  href="#"
                                  className="block px-4 py-2 text-gray-700 transition-colors hover:bg-[#19B2E7] hover:text-white"
                                >
                                  {subCategory}
                                </a>
                              </motion.li>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              >
                <FaShoppingCart />
                <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-[#19B2E7] text-xs text-white">
                  3
                </span>
              </a>
            </div>
