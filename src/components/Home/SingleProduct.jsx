...
const ProductSinglePage = () => {
  ...
  // New state for category and weight dropdowns
  ...
  // Function to navigate through thumbnails with looping
  ...
  // Update selectedImage when currentSlide changes
  useEffect(() => {
  ...
  return (
    <div className="mx-auto max-w-6xl p-4">
      ...
      <div className="flex flex-col gap-8 md:flex-row">
        ...
        {/* Main Product Content (Right Column) */}
        <div className="md:w-3/4">
          ...
          <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div>
              ...
              {/* Updated Looping Thumbnail Slider */}
              <div className="relative my-4 flex items-center justify-center">
                ...
                >
                  {thumbnails.map((thumb, index) => {
                    // Calculate position relative to currentSlide for visual loop effect
                    const isVisible =
                      index === currentSlide ||
                    ...
                    return (
                      <div
                        key={index}
                        className={`h-16 w-16 flex-shrink-0 cursor-pointer rounded border-2 transition-all duration-300 ${
                          selectedImage === index
                            ? "border-green-500"
                            : "border-gray-200"
                        } ${isVisible ? "opacity-100" : "absolute opacity-0"}`}
                        onClick={() => {
            ...
            <div>
              ...
              <div className="mb-6">
                <p className="mb-4 text-gray-700">
                  ...
                  flavors in these crispy potato chips. A delightful crunchy
                  snack for movie nights and casual gatherings.
                </p>
              </div>

              {/* Adjusted Size Selector Section */}
              <div className="mb-6">
              ...
              {/* Updated Add to Cart Section (Matches the image) */}
          ...
          <div>
            ...
            <div className="prose max-w-none">
              {activeTab === "Description" && (
                <>
                  <p className="mb-4">
                    ...
                    carefully selected for their exceptional flavor and
                    crunchiness. Each chip is delicately seasoned with our
                    signature American cream and onion flavoring, creating a
                    perfect balance of savory and tangy notes.
                  </p>

                  <ul className="mb-4 list-disc pl-5">
                    <li>
                      Premium quality potatoes, thinly sliced for the perfect
                      crunch
                    </li>
                    <li>Authentic American cream & onion flavoring</li>
                    <li>
                      Convenient 55g pack - perfect for individual consumption
                    </li>
                  ...
                  <p>
                    Whether you're enjoying them alone or sharing with friends,
                    these chips are guaranteed to satisfy your snack cravings.
                    Perfect for parties, movie nights, or as an everyday treat.
                    Each bite delivers that satisfying crunch you crave, along
                    with our signature cream and onion seasoning that keeps you
              ...
              {activeTab === "Reviews" && (
                <p>
                  These chips are fantastic - the flavor is authentic and the
                  crunch is perfect. I appreciate that they use quality
                  ingredients and don't have that artificial taste some other
                  brands have. The price point is excellent for the quality you
                  get. Will continue to purchase!
                </p>
              )}
              {activeTab === "Shipping" && (
