...
const ProductCard = ({ name, description, price, oldPrice, image }) => (
  <div className="group relative flex h-[400px] w-[290px] flex-col rounded-lg bg-[#f5f5f5] shadow-lg transition-transform duration-300 hover:scale-105">
    <div className="relative h-48 overflow-hidden rounded-t-lg sm:h-56 md:h-64">
      ...
      <div className="absolute top-0 left-0 mt-26 flex h-full w-full items-center justify-center opacity-0 transition-opacity group-hover:opacity-100">
        <div className="flex gap-1">
          ...
          <button className="rounded-full bg-white p-3 shadow-lg transition-all hover:bg-gray-200">
            <RiDeleteBin6Line size={15} className="text-[#0EA5E9]" />
          </button>
        </div>
      </div>
    </div>
