    ...
    <div className="w-full px-4">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">
          Top <span className="text-[#1E3A8A]">Selling</span>
        </h2>
        {/* Arrow Buttons */}
        <div className="flex gap-2">
          <button className="prev-buttons hover:bg-[#1E3A8A]">◀</button>
          <button className="next-buttons hover:bg-[#1E3A8A]">▶</button>
        </div>
      </div>
      ...
      <Swiper
        ...
        breakpoints={{
          ...
          768: { slidesPerView: 1, grid: { rows: 3 } },
          1024: { slidesPerView: 1, grid: { rows: 3 } },
        }}
      >
